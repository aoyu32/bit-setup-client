<template>
    <div class="user-post-collect">
        <AoTabs :tabs="tabs" v-model="activeTab">
            ...
            <template #content>
                <div class="post-collect-list">
                    <div class="post-collect-item" v-for="(postItem, index) in PostFilteData" :key="index">
...
@use '@/assets/styles/user/_user-post-collect.scss' as *;
</style>